...
function criarTabuleiro() {
    ...
    tamanhoCaixa = Math.floor(
        (larguraDisponivel - ((tamanhoGrid + 1) * tamanhoPontoNumero))
        / tamanhoGrid
    );
